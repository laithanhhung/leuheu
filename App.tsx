...
function App() {
  ...
  useLayoutEffect(() => {
    ...
    if (path) {
      ...
      // Trigger the animation on scrub
      gsap.to(path, {
        strokeDashoffset: 0,
        ease: "none",
        scrollTrigger: {
  ...
  return (
    <div className="spotlight relative min-h-screen font-sans selection:bg-neon-lime selection:text-black overflow-hidden">
      <Hero />

      <div className="text-neon-lime border-y-2 border-neon-lime/20">
